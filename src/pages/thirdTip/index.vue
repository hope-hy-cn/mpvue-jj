<template>
  <div class="thirdTip flexColAroundRowStretch">
    <div class="main">
      <div class="image flexColCenterRowCenter">
        <img
        src="https://image1.postop.cn/SmallProgram/yingyangshi/201904/third_tip.png"
        @error="handelError"
      >
      </img>
      </div>
...
export default {
  ...
  data () {
    return {
      nextPath:"/pages/dietEvaluation/main",
      tips:[]
    }
  },
  onLoad(){
  ...
  methods:{
    ...mapActions({
      getNutritionalRisk:"evaluation/getNutritionalRisk"
    }),
    clickButton(){
      wx.navigateTo({
        url:this.nextPath
